...
class ABDTxPowerViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        txPowerIndex = (txPowerStrings as NSArray).index(of: txPowerLabel?.text ?? 0) // wld
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if txPowerIndex != indexPath.row {
            ...
            if newCell?.accessoryType == .none {
                ...
                txPowerLabel?.text = txPowerStrings[txPowerIndex] as? String // wld as! to as?
            }
        ...
        //to review
            let arrayLength = command.count * MemoryLayout<Int8>.size  // wld changed var to let
